...
def generate_launch_description():
    # Paths to the files
    package_dir = get_package_share_directory('urdf_tutorial')
    urdf_file = os.path.join(package_dir, 'urdf', 'robot_model_6_dof.urdf.xacro')
    rviz_config = os.path.join(package_dir, 'config', 'robot_6_dof.rviz')
